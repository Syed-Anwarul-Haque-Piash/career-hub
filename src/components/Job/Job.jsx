    ...
    return (
        <div className='mt-8'>
            <div>
                ...
                <button className='bg-violet-300 text-white font-bold p-2 rounded mt-4 mr-4'>{remote_or_onsite}</button>
                <button className='bg-violet-300 text-white font-bold p-2 rounded mt-4'>{job_type}</button>
                <div className='md:flex'>
                    <h1 className='text-gray-400'>{location}</h1>
                    <h1 className='text-gray-400 ml-4'>{salary}</h1>
                </div>
                <button className='bg-violet-300 text-white font-bold p-2 rounded mt-4'>View Details</button>
            </div>
